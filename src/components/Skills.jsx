...
const Skills = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl border-b-4 rounded-sm font-bold border-sky-600 pb-2 inline-block mx-8 mb-2">
        Skills
      </h1>
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start box-border gap-4 custom-transition">
        <div className="flex-wrap flex bg-[#343434] flex-col rounded-lg w-full md:w-fit mt-3 items-start custom-transition px-4 py-3 shadow-lg">
          <h1 className="text-xl font-semibold mb-2">Techs & Languages </h1>
          {techs.map((tech) => {
            const Ico = tech.ico;
            return (
              <div className="flex justify-center items-center gap-3 p-3 border-box custom-transition ">
