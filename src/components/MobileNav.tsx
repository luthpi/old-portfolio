      ...
      <div
        ...
        className={
          !nav
            ...
            : "mnshadow translate-y-100 fixed right-0 top-0 box-border flex h-fit w-[45vw] flex-col items-center justify-center rounded-bl-2xl border-b-[2px] border-l-[2px] border-gray-400 bg-[#161616] pb-14 pt-6 md:hidden"
        }
      >
