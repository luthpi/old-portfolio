  ...
  return (
    <>
      ...
      <div
        ...
        className={
          !nav
            ? "mnshadow fixed right-0 top-0 box-border flex h-fit w-[55vw] translate-y-[-120%] flex-col items-center justify-center rounded-bl-2xl border-b-[2px] border-l-[2px] border-gray-400 bg-[#161616] pb-14 pt-6 shadow-2xl md:hidden"
            : "mnshadow translate-y-100 fixed right-0 top-0 box-border flex h-fit w-[55vw] flex-col items-center justify-center rounded-bl-2xl border-b-[2px] border-l-[2px] border-gray-400 bg-[#161616] pb-14 pt-6 md:hidden"
        }
      >
